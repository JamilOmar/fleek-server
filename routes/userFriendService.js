...
router.post('/addUserFriend', function(req, res) {
    ...
    var userFriendL = new userFriendLogic();
    var response = new responseWs();
    userFriend.initializer(req.body);
    userFriendL.addUserFriend(userFriend, function(err, result) {
        userFriendL = null;
        userFriend = null;
        if (err) {
...
router.put('/approvalUserFriend', function(req, res) {
    ...
    var response = new responseWs();
    userFriend.initializer(req.body);
    userFriendL.approvalUserFriend(userFriend, function(err, result) {
        userFriendL = null;
        userFriend = null;
        if (err) {
...
router.put('/removeUserFriend', function(req, res) {
    ...
    var response = new responseWs();
    userFriend.initializer(req.body);
    userFriendL.removeUserFriend(userFriend, function(err, result) {
        userFriendL = null;
        userFriend = null;
        if (err) {
